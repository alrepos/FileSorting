...
Run the "FileSorter" app to sort text data from an input file and save the ordered output to a new file. File size, input and output paths can be passed to the parameters of the main "StartSorting" method to override default values (0.3 Gb and public "Documents" folder).
